...
public class ICWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ICWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ICWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ICWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ICWDateTimeConverter dateTimeConverter = new ICWStandardDateTimeConverter();

    public ICWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ICWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ICWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ICWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ICWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ICWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
