...
public class ICWKPSPublicSoap
{
    ...
    public ICWKPSPublicSoap(){}

    public ICWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ICWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ICWExtendedSoapSerializationEnvelope envelope= new ICWExtendedSoapSerializationEnvelope(ICWExtendedSoapSerializationEnvelope.VER11);
